...
// Exercice 4
// Insérez votre code ici
let user = [firstname,lastname,age,birthYear,year];
// Ne touchez pas à ceci
...
backgroundColor = "rgb(100, 92, 192)";
document.body.style.backgroundColor = backgroundColor;
...
let car = {
    ...
    color: "black",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTzW1GTfD_-EJd9PoZVhiFAP2xgA116eIYz_Vyd68IY&s",
  };
